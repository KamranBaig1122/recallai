...
class NotificationConsumer(AsyncWebsocketConsumer):
    ...
    Sends notifications to frontend when unresolved meetings need attention.
    """
    ...
    async def connect(self):
        ...
        await self.accept()
        print(f'[ws] Notification consumer connected for user {self.user_id}')
    ...
    async def disconnect(self, close_code):
        ...
        print(f'[ws] Notification consumer disconnected (code: {close_code})')
